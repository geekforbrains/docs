...
Bundled skills are automatically installed to `~/.operator/skills/` on startup when missing. On upgrades, new bundled skills are added without touching existing ones.
